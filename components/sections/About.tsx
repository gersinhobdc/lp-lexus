...
export function About() {
  return (
    <section id="sobre" className="py-24 bg-[#0C1F40]" aria-label="Sobre a Lexus">
      <div className="section-container">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative aspect-[4/5] rounded-2xl overflow-hidden bg-[#13284D] border border-white/5">
              <Image
