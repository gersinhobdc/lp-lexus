...
export function Projects() {
  return (
    <section id="projetos" className="py-24 bg-[#0C1F40]" aria-label="Projetos realizados">
        ...
        >
          {PROJECT_SHOWCASE.map((project) => (
            <motion.a
              ...
              variants={fadeUp}
              className={`group relative rounded-2xl overflow-hidden bg-[#13284D] border border-white/5 hover:border-white/15 transition-all duration-300 flex flex-col justify-between p-6 min-h-[220px] ${project.span}`}
            >
